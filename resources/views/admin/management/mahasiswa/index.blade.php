...
@section('content')
    ...
    <div
        ...
        <form action="{{ route('admin.management.mahasiswa.index') }}" method="GET" class="w-full md:w-1/2 relative">
            <div class="relative">
            ...
            <div @click.away="open = false" x-show="open" x-transition:enter="ease-out duration-300"
                ...
                <form action="{{ route('admin.management.mahasiswa.import') }}" method="POST"
                    ...
                    <div class="bg-blue-50 border border-blue-100 rounded-xl p-4 mb-5 flex items-start gap-3">
                        ...
                        <div>
                            <h4 class="text-sm font-bold text-blue-900 mb-1">Panduan Import Data Mahasiswa</h4>
                            <p class="text-xs text-blue-800 mb-2 leading-relaxed">
                                Pastikan format kolom (header) pada file Excel Anda sama persis dengan format sistem
                                (seperti NIM, Prodi, dll) agar data terbaca dengan benar.
                            </p>
                            <a href="{{ asset('template/template_import_mahasiswa.xlsx') }}" download
